...
import '../shared_mocks/shared_mocks.mocks.dart';
 ...
 void main(){
  ...
  final Movie movie = Movie(adult: true, backdrop_path: "", genre_ids: [], id: 1, original_language: "en", original_title:"original title", overview: "overview", popularity: 7, release_date: DateTime(2020,01,01), title: "title", video: true, vote_average: 5.5, vote_count:100);
 ...
 group('FavouriteMovieBloc',(){
   ...
   setUp((){
   favoritemovieBloc = FavoritemovieBloc(dataSource:mockMovieLocalDataSource );
   });
   ...
   blocTest<FavoritemovieBloc, FavoritemovieState>(
    ...
    expect: () => [FavoritemovieHasDataSynced(favourites: {movie})],
);
 blocTest<FavoritemovieBloc, FavoritemovieState>(
    ...
    expect: () => [FavoritemovieHasDataSynced(favourites: {movie}),FavoritemovieEmpty()],
);
 });
